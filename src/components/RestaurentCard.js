...
const RestaurentCard = (props) =>{
    ...
    <div className="rest-wraper">
      <div className="rest-img-container">
        <div className="rest-main-img-c">
          <img className="rest-img" src={"https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_660/"+cloudinaryImageId} alt="Wow! Momo"></img>
        </div>
      </div>
    ...
    <div className="rest-text" >
      ...
      <div className="add-cusine padding-10" >
